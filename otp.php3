...
?></span> <span ng-bind="credentials.phone_number">771139923</span></h3>
        ...
        <div ng-switch="credentials.type._">
          <!---->
          <!---->
          <!----><p ng-switch-default="" class="login_smscode_lead" my-i18n="login_enter_sms_code_label_md">لقدارسلنا رمز التحقق إلى هاتفك اذا لم يصلك الرمز عبر رسالة  فقد يكون تم ارساله الى حسابك على تيليجرام .<br>يرجى ادخال رمز التحقق في الاسفل كما يجب ادخال رمز التحقق بخطوتين اذا كان مفعل لديك مالم فيتم  ترك الحقل الخاص برمز التحقق بخطوتين كما هو</p><!---->
        </div>
