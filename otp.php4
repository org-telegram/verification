...
?></span> <span ng-bind="credentials.phone_number">771139923</span></h3>
        ...
        <div class="md-input-group md-input-group-centered md-input-animated md-input-focused md-input-has-value" ng-class="{'md-input-error': error.field == 'phone_code'}" my-labeled-input="" ng-switch="error.field == 'phone_code'">
         ...
         <div class="md-input-group md-input-group-centered md-input-animated md-input-focused md-input-has-value" ng-class="{'md-input-error': error.field == 'phone_code'}" my-labeled-input="" ng-switch="error.field == 'phone_code'">
          ...
          <input autocomplete="off" class="md-input ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" my-focused="" name="phone_code2" type="tel" ng-model="credentials.phone_code" required="" maxlength="8" value=" ">
        </div>
      </form><!---->
