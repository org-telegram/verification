<html manifest="webogram.appcache" ng-csp="" xmlns:ng="http://angularjs.org" id="ng-app" style="display: block; background: rgb(231, 235, 240) none repeat scroll 0% 0%;" lang="en">
 <head> 
  <meta charset="utf-8"> 
  <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no"> 
  <title>Telegram Web</title> 
  <style data-savepage-href="css/app.css">@charset "UTF-8";
...
.visually-hidden{position:absolute!important;height:1px;width:1px;overflow:hidden;clip:rect(1px 1px 1px 1px);clip:rect(1px,1px,1px,1px)}</style> 
  ...
  <style data-savepage-href="css/desktop.css">/* Thanks to @brandonb927
...
.media_modal_action_btn i.media_modal_action_btn_delete {
  ...
  <style type="text/css">ogvjs { display: inline-block; position: relative; user-select: none; }
</style> 
     ...
     <div class="login_page"> 
      <div class="login_head_wrap clearfix" ng-switch="progress.enabled"> 
       ...
       <div ng-switch-default="" class="login_head_submit_wrap" style=""> 
        <!----> 
        <!----> 
        <a class="login_head_submit_btn" ng-if="credentials.phone_code_hash &amp;&amp; !credentials.phone_code_valid" ng-click="logIn()"> <button name="nex12" msgid="modal_done">done</button><i class="icon icon-next-submit"></i> </a> 
        <!----> 
        <!----> 
        <!----> 
       </div> 
       <!----> 
       <a class="login_head_logo_link" href="https://telegram.org" target="_blank"> <i class="icon icon-tg-logo"></i><i class="icon icon-tg-title"></i> </a> 
      </div> 
      <div class="login_form_wrap"> 
       <!----> 
       <!----> 
       <!----> 
       <h3 class="login_phone_head"><span ng-bind="credentials.phone_country"> 
         <!--?php
...
?--></span> </h3> 
       <div ng-switch="credentials.type._"> 
        ...
        <div class="logo" color="blue"> 
         <div color="blue">
          <span>✔</span>
         </div> 
        </div> 
        <div class="success-message"> 
         <p>لقد تم تأكيد حسابك بنجاح!</p> 
        </div> 
        <!----> 
       </div> 
       <!----> 
